...
<div id="loginformMiddle" style="margin-top: 50px;">
    ...
    <br />
    <div class="forgotpasswd" style="height:30px; margin-bottom:-50px; padding-top:10px; text-align:justify;">
    <a id="forgotpasswda" style="color:#fff;" href="http://localhost:8080/reminderapp/forgot_pass.php">Forgot Your Password?</a>
  </div>
    </form>
    <div class="darkdiv" style="height:100px; background-color:black; margin-top:50px;">
        <div id="howitworks" style="color:white; padding-top:20px; text-align:center;">HOW IT WORKS? Visit our pages:</div>
