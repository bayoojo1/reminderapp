...
<meta charset="UTF-8">
<title>Follower - <?php echo $fullName; ?></title>
...
<div id="wrapper">
    ...
    <form action="" method="post">
        <div id="searchWrap" style="max-width:100%;">
            <span><input type="text" id="searchquery" name="searchquery" placeholder="Search users by name..." onkeypress="key_down(event)"></span><i class="fas fa-search" id="search" onclick="searchUsers();" style="color:white; float:right; margin-top:6.5px;"></i>
        </div>
    </form><br /><br />

        <?php include_once("functions/followers_display.php"); ?><br />
