...
<head>
<meta charset="UTF-8">
<title>My Subscription - <?php echo $fullName; ?></title>
...
<div id="wrapper">
    ...
    <form action="" method="post">
        <div id="searchWrap" style="max-width:100%;">
            <span><input type="text" id="searchprovider" name="searchprovider" placeholder="Search providers by categories..." onkeypress="key_down_providers(event)"></span>
        ...
        <?php include_once("functions/subscription.php"); ?><br />
